    ...
    >
      ...
      <div className="mt-auto px-4 pb-4 sm:px-5 sm:pb-5">
        <motion.button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 via-rose-500 to-orange-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-orange-500/25 transition-[box-shadow,transform] hover:shadow-lg hover:shadow-orange-500/35"
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
        >
          View Menu
