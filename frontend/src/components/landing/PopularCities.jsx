  ...
  return (
    ...
    >
      <div className="text-center mb-20">
        <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-linear-to-r from-emerald-500/20 to-teal-500/20 text-emerald-700 border border-emerald-200/50 backdrop-blur-sm shadow-lg">
          🌟 Featured Destinations
        </span>
        <h2 className="text-5xl lg:text-7xl font-black mb-8 bg-linear-to-r from-slate-900 via-gray-900 to-black bg-clip-text text-transparent drop-shadow-2xl leading-tight">
          Popular Cities
        </h2>
        ...
        {cities.map((city) => (
          ...
          >
            ...
            <div className="relative aspect-5/3 overflow-hidden">
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/40 to-transparent group-hover/card:from-black/60 group-hover/card:via-black/20" />
              ...
              <div className="absolute top-8 right-8 opacity-0 group-hover/card:opacity-100 translate-y-4 group-hover/card:translate-y-0 transition-all duration-700 delay-150">
                <div className="w-16 h-16 bg-white/95 backdrop-blur-2xl rounded-3xl flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-400 hover:scale-110 hover:-rotate-6 group-hover/card:bg-linear-to-r group-hover/card:from-amber-400 group-hover/card:to-orange-500">
                  <svg
            ...
            <div className="p-10 pb-8 relative z-10">
              <div className="flex items-center justify-between opacity-0 translate-y-6 group-hover/card:opacity-100 group-hover/card:translate-y-0 transition-all duration-700 delay-300">
                <span className="text-2xl font-black bg-linear-to-r from-gray-900 to-slate-800 bg-clip-text text-transparent tracking-wide">
                  Explore Now
                </span>
                <div className="w-14 h-14 bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-3xl flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-400 hover:scale-110 hover:rotate-12 backdrop-blur-xl ring-2 ring-white/50">
                  <svg
