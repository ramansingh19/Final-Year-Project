        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              className="absolute right-3.5 top-3.5 z-30 flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white/70 shadow-md backdrop-blur hover:text-white"
            >
            ...
            {imgs.length > 1 && (
              <div
                ref={thumbnailRef}
                className="flex gap-2 overflow-x-auto border-b border-white/10 bg-white/5 px-4 py-2.5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
              >
                {imgs.map((src, i) => (
                  <motion.button
                    key={i}
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain">
              <div className="p-5 sm:p-6">
                ...
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div>
                    <h2 className="text-xl font-extrabold capitalize leading-tight text-white sm:text-2xl">
                ...
                {/* Keyboard hint */}
                <p className="mt-3 text-center text-[10px] font-medium tracking-wide text-white/40">
