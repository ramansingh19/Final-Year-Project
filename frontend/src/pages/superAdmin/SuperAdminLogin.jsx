...
{/* 🔥 Glow Effects */}
<div className="absolute w-72 h-72 bg-blue-200/30 rounded-full blur-3xl -top-32 -left-32 animate-pulse"></div>
<div className="absolute w-96 h-96 bg-indigo-200/30 rounded-full blur-3xl -bottom-40 -right-32 animate-pulse"></div>
...
<div className="relative z-10 w-full flex justify-center p-6">
  <div className="w-full max-w-md bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl p-8 border border-gray-200">
    ...
    <div className="text-center mb-8">
      ...
      <div className="w-12 h-1 bg-blue-600 mx-auto mt-4 rounded-full animate-pulse"></div>
    </div>
    ...
    <form onSubmit={handelSubmit} className="space-y-5">
      ...
      {/* ERROR */}
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-600 text-sm text-center py-2 px-3 rounded-lg animate-pulse">
          {error}
        </div>
      )}
