      ...
      {!loading && hotels.length > 0 && (
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {hotels.map((hotel) => (
            <div
              key={hotel._id}
              className="group cursor-pointer bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border"
            >
              {/* IMAGE */}
              ...
              <div className="p-4">
                ...
                <div className="flex gap-2 mt-4">
                  <button onClick={() => handelActiveButtton(hotel._id)} className="flex-1 bg-green-500 hover:bg-green-600 text-white text-sm py-1 rounded">
                    Activate
                  </button>
                  <button onClick={() => handelDeleteCityButton(hotel._id)} className="flex-1 bg-red-500 hover:bg-red-600 text-white text-sm py-1 rounded">
                    Delete
                  </button>
                </div>
