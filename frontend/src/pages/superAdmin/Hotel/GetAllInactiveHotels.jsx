      ...
      <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between relative z-10">
        <div className="flex-1">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <div className="rounded-2xl border border-blue-200 bg-blue-50 px-5 py-4 animate-fadeIn delay-100">
        ...
        <div className="w-full xl:max-w-md">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-gray-200 bg-white py-4 pl-12 pr-4 text-gray-900 placeholder-gray-400 outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
            />
          </div>
        </div>
      </div>
                ...
                >
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      <img
                        src={
                          hotel.images?.[0] || "https://via.placeholder.com/80"
                        }
                        alt={hotel.name}
                  ...
                  <td className="px-6 py-5">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="inline-flex items-center rounded-xl bg-green-100 px-4 py-2 text-sm font-medium text-green-700 transition hover:bg-green-200"
                      >
    ...
    {selectedHotel && (
      <div className="fixed inset-0 z-50 flex justify-end bg-white/80 backdrop-blur-sm">
        <div className="h-full w-full max-w-md overflow-y-auto border-l border-gray-200 bg-white p-6 shadow-lg animate-[slideIn_.35s_ease]">
          ...
          <img
            src={
              selectedHotel.images?.[0] || "https://via.placeholder.com/600x300"
            }
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-gray-100 p-4">
            ...
            <h4 className="mt-2 text-2xl font-bold text-red-600">Inactive</h4>
          </div>
        </div>
      </div>
    )}
