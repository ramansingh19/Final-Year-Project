        ...
        <div className="relative z-10 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row xl:flex-col gap-4 w-full xl:w-auto">
            <Link
              ...
              className="group w-full sm:w-auto sm:min-w-55 rounded-2xl border border-blue-500/20 bg-linear-to-r from-blue-600 to-indigo-600 px-6 py-4 font-semibold text-white shadow-[0_10px_30px_rgba(37,99,235,0.35)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(37,99,235,0.45)]"
            >
            ...
            <Link
              ...
              className="group w-full sm:w-auto sm:min-w-55 rounded-2xl border border-white/10 bg-white/5 px-6 py-4 font-semibold text-white backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white/10 hover:border-white/20"
            >
              <div className="flex items-center justify-between">
                <span>Add Room</span>
                <FaArrowRight className="transition-transform duration-300 group-hover:translate-x-1" />
